...
Remove-Module PSGetInternal -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSGetInternal\PSGetInternal.psd1"
Import-Module "$PSScriptRoot\..\PSGetInternal\PSGetInternal.psm1" -Force
