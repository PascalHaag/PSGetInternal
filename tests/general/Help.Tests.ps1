...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PSGetInternal\functions", "$global:testroot\..\PSGetInternal\internal\functions"),
	
	[string]
	$ModuleName = "PSGetInternal",
...
$CommandPath = @(
    "$global:testroot\..\PSGetInternal\functions"
    "$global:testroot\..\PSGetInternal\internal\functions"
)
